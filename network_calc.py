...
class Ui_NetworkCalcDialog(object):
    def setupUi(self, NetworkCalcDialog):
        ...
        self.AdjustedList.setSelectionMode(QtWidgets.QAbstractItemView.ExtendedSelection)
    ...
    def retranslateUi(self, NetworkCalcDialog):
        ...
        NetworkCalcDialog.setWindowTitle(_translate("NetworkCalcDialog", "Network Adjustment"))
        ...
        self.ResultGroup.setTitle(_translate("NetworkCalcDialog", "Result of Calculations"))
        ...
        self.ConfidenceLabel.setText(_translate("NetworkCalcDialog", "Confidence Level"))
        self.DistDevLabel.setText(_translate("NetworkCalcDialog", "Distance standard deviation"))
        ...
        self.ZenitDevLabel.setText(_translate("NetworkCalcDialog", "Angle standard deviation"))
...
if __name__ == "__main__":
    ...
    NetworkCalcDialog = QtWidgets.QDialog()
    ui = Ui_NetworkCalcDialog()
    ui.setupUi(NetworkCalcDialog)
    NetworkCalcDialog.show()
    sys.exit(app.exec_())
