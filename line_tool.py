...
class LineMapTool(QgsMapToolEmitPoint):
    ...
    def deactivate(self):
        ...
        """
        try:
            self.rubberBand.reset()  # erase rubberband line
        except:
            pass
    ...
    def divide(self):
        ...
        point1 = self.toLayerCoordinates(self.layer, QgsPointXY(self.startPoint.x(), self.startPoint.y()))
        point2 = self.toLayerCoordinates(self.layer, QgsPointXY(self.endPoint.x(), self.endPoint.y()))
